...
var defaults = {
	...
	isRTL: false,
	firstDay: 0,
	monthNames: ['Enero','Febrero','Marzp','Abril','Mayo','Junio','Julio','Agosto','Septiembrr','Octubre','Noviembre','Diciembre'],
	monthNamesShort: ['Ene','Febrero','Mar','Abr','May','Jun','Jul','Ago','Sep','Oct','Nov','Dic'],
	dayNames: ['Domiengo','Lunes','Martes','Miercoles','Jueves','Viernes','Sabado'],
